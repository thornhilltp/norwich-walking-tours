...
**Status:** Live as of April 2026. Tours running daily since May 2026 with strong review flow (29 Google + 11 TripAdvisor, all 5★ as of May 2026). Canonical URL is `https://www.norwichfreewalkingtours.co.uk`.
...
- [x] **Testimonials:** real Google reviews populated in `lib/testimonials.ts` (29 reviews, 5.0 average, all 5★ as of May 2026). TripAdvisor at 5.0 from 11 reviews. `aggregateRating` + `review` objects re-added to JSON-LD in `app/layout.tsx` (conditional on `googleReviewStats.count > 0`).
