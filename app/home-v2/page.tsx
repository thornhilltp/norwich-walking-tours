// EXPERIMENTAL HOMEPAGE — /home-v2
// Round 1 changes (vs app/page.tsx):
//   1. HeroV2 — value-prop H1, removed 3rd paragraph + secondary CTA, standardised tip copy
//   2. TipAnchor band restored between HowItWorks and PracticalInfo, anchored at £10-£20
//   3. PracticalInfo H2 renamed to "Before you come" so it no longer duplicates FAQ's H2
//   4. PracticalInfo CTA footer standardised: "Tip what it was worth at the end"
// All shared components in components/* are UNCHANGED — / stays bit-identical until swap.
...
import { TipAnchor } from "./_components/TipAnchor";
...
// Round-1 change: H2 renamed from "Everything you need to know" → "Before you come"
// so it no longer duplicates the FAQ section's H2 further down the page.
      ...
      <div className="brand-container max-w-3xl mx-auto">
        ...
        <div className="mt-10 text-center">
          ...
          <p className="text-sm text-muted-foreground mt-3" style={{ fontFamily: "var(--font-lora), Georgia, serif" }}>
            Booking required &bull; Free to book &bull; Tip what it was worth at the end
          </p>
...
function LocalGuidesTeaser() {
  const guides = [
    { href: "/things-to-do/free", title: "Free things to do in Norwich", blurb: "Ten things a local would actually recommend." },
    { href: "/explore/where-to-stay-norwich", title: "Where to stay in Norwich", blurb: "Five neighbourhoods, who each one suits, walking time to The Forum." },
    { href: "/explore", title: "More Norwich guides", blurb: "Walks, weekends, pubs, rainy days. The full hub." },
  ];
  return (
